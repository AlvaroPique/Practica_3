...
public class TrackingReceiver : MonoBehaviour
{
    ...
    //OSC Variables
    private OSCReceiver _receiver;  //the person who recives the message
    private const string _oscAddress = "/pose/0";  //the same adress that we have in the OSC Console and the documentation
